...
export const METHOD = {
  ...
  exclusions: {
    ...
    items: [
      ...
      'Public transport uses a UK rail factor as an indicative proxy pending a published NSW per-passenger-km figure. Where public transport is entered as weekly spend in the guided audit, the spend is capped at the state weekly fare cap before it converts to kilometres (NSW: the $50 Adult Opal weekly travel cap), because spending past the cap buys no extra travel; the visitor can override the cap.',
