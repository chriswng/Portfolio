...
export const ONBOARD = {
  ...
  advanced: {
    ...
    homeNote: 'Only a home you built or bought new counts here: a new purchase is what pulled that construction into existence. Buy an existing home and you caused no new build, so it adds nothing, which is the point. Leave this off if you rent.',
