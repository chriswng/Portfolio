...
export const ONBOARD = {
  ...
  food: {
    ...
    intlOrdersNote: 'Think express orders from overseas that land within a week or two: fast fashion, gadgets, small parcels flown rather than shipped. Slow sea-freight orders count as ordinary parcels above.',
  },
  ...
  advanced: {
    ...
    healthNote: 'Gap payments, pharmacy, physio, dental, glasses: whatever actually leaves your pocket, not what Medicare or insurance covers. Typically $20 to $150 a month. Not sure? $50 is a fair estimate, about one pharmacy run plus a specialist gap fee.',
...
export const METHOD = {
  ...
  sources: {
    ...
    paras: [
      ...
      'The calculator also runs a United States or New Zealand audit, with the home country picked in the first step. US electricity is priced from the state you live in: every state, the District of Columbia and Puerto Rico carries its own factor from the EPA eGRID2023 workbook, read cell for cell. The American grid runs from about 0.02 kg CO₂-e per kWh in Vermont to about 0.89 in West Virginia, a spread of nearly forty times, so a national average flattered half the country while punishing the other half. Scope 3 adds the eGRID grid gross loss of 4.2 per cent. US gas and road fuels use the EPA GHG Emission Factors Hub defaults. New Zealand electricity, gas, road fuels and hotel nights now come from the MfE Measuring Emissions Catalogue 2026 rather than the Australian stand-ins they used before, including the separate transmission-loss factor that the electricity line previously left out. One New Zealand line still rides a proxy: the fuel-cycle (scope 3) side of petrol and diesel, where the catalogue publishes no equivalent, so the Australian well-to-tank factors stand in and the table says so.',
